...
export const useDocsStore = defineStore('docs', () => {
  ...
  const milestones = ref<MilestoneItem[]>([
    ...
    {
      id: 'M15',
      name: 'WP-5.1: Performance Benchmark & Memory Optimization',
      ...
      completion: 0,
      date: 'Pending',
      summary: 'High-throughput event bus stress testing, memory profiling, and allocation benchmarks.',
      deliverables: ['Performance Benchmark Suite', 'Memory Profiler Report'],
      owner: 'Core Team',
    ...
    {
      id: 'M16',
      name: 'WP-5.2: Reliability & Fault Tolerance',
      ...
      completion: 0,
      date: 'Pending',
      summary: 'DLQ retry strategies, circuit breakers, and panic isolation shields.',
      deliverables: ['Circuit Breaker Module', 'Fault Resilience Engine'],
      owner: 'Core Team',
      reviewStatus: 'Pending',
      notes: 'Roadmap Sprint 4'
    },
    {
      id: 'M17',
      name: 'WP-5.3: Observability & Metrics Dashboard',
      ...
      completion: 0,
      date: 'Pending',
      summary: 'Real-time telemetry dashboards, structured logging, and health monitoring.',
      deliverables: ['Telemetry Dashboard', 'Metrics Exporter'],
      owner: 'Core Team',
      reviewStatus: 'Pending',
      notes: 'Roadmap Sprint 4'
    },
    {
      id: 'M18',
      name: 'WP-5.4: Security Compliance & Audit',
      ...
      completion: 0,
      date: 'Pending',
      summary: 'Dependency security scanning, MV3 permission boundary audit, and CSP compliance.',
      deliverables: ['Security Audit Report', 'Permission Matrix'],
      owner: 'Security Team',
      reviewStatus: 'Pending',
      notes: 'Roadmap Sprint 4'
    },
  ...
  const projectInfo = computed(() => {
    ...
    return {
      ...
      version: '1.0.0',
      currentSprint: 'Sprint D1.5 (Portal Synchronization Engine)',
      currentMilestone: 'M11 (Metadata Registry & Portal v1.0 Final)',
      currentPhaseGroup: 'Phase 3: Documentation & Metadata Governance',
      currentModule: 'docs-portal/src/services/metadata-engine.ts',
      nextSprint: 'Sprint 3B Phase 3 (IPC Bridges & Cross-Context Proxy)',
      architectureStatus: 'APPROVED & FROZEN (v3.1 SAD & Addendum)',
      buildStatus: 'CLEAN (0 Errors, 0 Warnings)',
      testingStatus: 'VERIFIED (5/5 Spec Tests Passed)',
      ...
      testCoverage: '100% Core Pub/Sub & Pipeline API',
      
      buildMetrics: {
        status: 'PASSING',
        latestBuild: '20260731.3',
        avgBuildTime: '1.49s',
      ...
      testMetrics: {
        ...
        unitTests: 5,
        integrationTests: 3,
        coverage: '100% Core Pipeline API'
      },
